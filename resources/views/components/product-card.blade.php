...
<div class="flex text-white flex-col text-center p-4 bg-slate-400  rounded-xl border border-transparent hover:border-blue-500 group transition-colors duration-100">
